                ...
                return {
                    ...
                    build: function (options) {
                        ...
                        if (!_.isEmpty(this.form.related) || !_.isEmpty(this.form.relatedButtons)) {
                            ...
                            if (this.mode === "edit") {
                                ...
                                for (itm in this.form.related) {
                                    ...
                                    console.log("User" + relatedTabSelected);
                        ...
                        if (!_.isEmpty(this.form.tabs)) {
                            ...
                            html += `<div id="${this.form.name}_tab" class="Form-tab {{select0}}" `;
                            html += `ng-click="select(0)" >`;
                            html += `${details}</div>`;
                            for (itm in this.form.tabs) {
                                collection = this.form.tabs[itm];
                                var select_var = "select" + this.form.tabs[itm].index;
                                console.log("TABS = " + select_var);
                                html += `<div id="${itm}_tab" ` +
                                    `class="Form-tab {{` + select_var + `}}" `;
