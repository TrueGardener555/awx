    ...
    function ($injector, $stateExtender, $log, i18n) {
        return {
            ...
            */
            generateTree: function (params) {
                ...
                return new Promise((resolve) => {
                    ...
                    if (params.list) {
                        ...
                        if (params.modalDlg) {
                            listState = this.generateListNode(list, params, true);

                        } else {
                            listState = this.generateListNode(list, params, false);
                        }
             ...
             */
            generateListNode: function (list, params, modaldlg) {
                let state,
                ...
                function generateTemplateBlock() {
                    if (params.templates && params.templates.list) {
                        ...
                        return function (ListDefinition, generateList) {
                            ...
                            html = generateList.insertFormView(modaldlg) + html;
